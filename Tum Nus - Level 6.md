...
Arcana (Int) [+4]  [Proficiency]
Athletics (Str) [-1]
Deception (Cha) [+5]
History (Int) [+1]
Insight (Wis) [+5]  [Proficiency]
Intimidation (Cha) [+5]
Investigation (Int) [+1]
Medicine (Wis) [+4]
Nature (Int) [+1]
Perception (Wis) [+2]
Performance (Cha) [+8]  [Proficiency]
Persuasion (Cha) [+8]  [Proficiency]
Religion (Int) [+1]
...
## Magical Items
- Bag of Holding
- Crystal of Containment [Attuned]
...
- Immovable Rod
	...
	- Rod can hold up to 8000 pounds of weight
- Eversmoking Bottle
	- On opening this bottle a cloud of thick smoke in 60 foot area causing heavily obscured Increases by 10 feet every turn up to 120 feet.
	- Requires an action to close the bottle
		- Command word to close it is "smoke"
- Alchemy Jug
	- Ceramic jug that holds a gallon of liquid
	- Weighs 12 pounds
	- Once a day: Use an action and name a liquid and it can pour 2 gallons per minute
		- Can pour that liquid for the rest of that day until it hits max cap (dependent on liquid)
		- List of allowed liquids
			- Acid, Basic poison (1/2 oz), Beer, Honey, Mayo, Oil (1 quart), Vinegar, Fresh Water, Salt Water, Wine
- Amulet of Proof Against Magical Detection
	- Cannot be detected magically with divination magic[In Shroud's possession]
- Seeker's Compass
...
- (2x) Broken Pickaxes
- (3x) Bottles worth of Numinous tainted water
	- Enhances magic
- (2x) Iron Crown 
...
- Incriminating Documents
	- From Xyther
	- Everything listed in this are off the books transactions
		- Includes poisons, toxins, stolen goods, counterfeits, human trafficking, etc.
	- Laboured effort to keep details surrounding human trafficking omitted
	- Locations of human trafficking delivery is almost always Beraven (Crowport) or Renholt, but also had Lundris surprisingly
- Ornate Broach
	- Given by Mavis
	- SHOULD SHOW IF WE ENCOUNTER THE RATS
- Key to Bill's house in Mosa
- The bones of William Chance wrapped in his cloak
- Heretic Book of Zello and Quallo
- Blighted Soil from the farm outside of Caladar
	- Tainted with necromantic magic
- Lily's Holy Symbol
	- Previously was symbol of Ollo, now contains closed hands. Feels like it's still Ollo, but foreign and wrong
- Teft's Incense Chain
- Teft's Key Chain
	- 1 Skull Key
	- 1 Feather Key
	- 1 Heart key
...
- 4 Hagsbite doses worth of Black Poppy
	- Can be used to craft Hagsbite
- 4 Hagsbite doses worth of Wasp Vine
	- Can be used to craft Hagsbite
- Hagsbite dose (1x)
- 5 Iron teeth from Teft
- 3 Iron metal disks
- (4x) Miniature Black iron Disks
